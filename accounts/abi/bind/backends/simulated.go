...
import (
	...
	"github.com/fulcrumchain/indigo/accounts/abi/bind"
	"github.com/fulcrumchain/indigo/common"
	"github.com/fulcrumchain/indigo/common/hexutil"
	"github.com/fulcrumchain/indigo/common/math"
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call indigo.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call indigo.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call indigo.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call indigo.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, uint64, bool, error) {
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query indigo.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query indigo.FilterQuery, ch chan<- types.Log) (indigo.Subscription, error) {
