...
Section "Indigo" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Indigo incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Indigo outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Indigo UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Indigo incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Indigo outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Indigo UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30303 "" ""
