...
func TestAccountListEmpty(t *testing.T) {
	geth := runIndigo(t, "account", "list")
	geth.ExpectExit()
}

func TestAccountList(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	geth := runIndigo(t, "account", "list", "--datadir", datadir)
...
func TestAccountNew(t *testing.T) {
	geth := runIndigo(t, "account", "new", "--lightkdf")
	defer geth.ExpectExit()
	geth.Expect(`
...
func TestAccountUpdate(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	geth := runIndigo(t, "account", "update",
...
func TestWalletImport(t *testing.T) {
	geth := runIndigo(t, "wallet", "import", "--lightkdf", "testdata/guswallet.json")
	defer geth.ExpectExit()
	geth.Expect(`
!! Unsupported terminal, password will be echoed.
