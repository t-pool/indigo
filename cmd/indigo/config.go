...
func loadConfig(file string, cfg *indigoConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "indigo.ipc"
	return cfg
}

func makeConfigNode(ctx *cli.Context) (*node.Node, indigoConfig) {
	// Load defaults.
	cfg := indigoConfig{
...
func makeFullNode(ctx *cli.Context) *node.Node {
	...
	// Add the Indigo Stats daemon if requested.
	if cfg.Netstats.URL != "" {
