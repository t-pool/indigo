...
import (
	...
	"github.com/fulcrumchain/indigo/internal/jsre"
	"github.com/fulcrumchain/indigo/internal/web3ext"
...
// Welcome show summary of current Indigo instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Indigo metadata
	fmt.Fprintf(c.printer, "Welcome to the Indigo JavaScript console!\n\n")
	c.jsre.Run(`
