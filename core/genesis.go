...
// DefaultGenesisBlock returns the Indigo main net genesis block.
...
// DefaultTestnetGenesisBlock returns the Indigo Testnet network genesis block.
...
// DeveloperGenesisBlock returns the 'indigo --dev' genesis block. Note, this must
