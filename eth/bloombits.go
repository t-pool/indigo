...
import (
	...
	"github.com/fulcrumchain/indigo/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Indigo
...
func (gc *Indigo) startBloomHandlers() {
...
// for the Indigo header bloom filters, permitting blazing fast filtering.
