...
// Package les implements the Light Indigo Subprotocol.
package les
...
import (
	...
	"github.com/fulcrumchain/indigo/light"
	...
	rpc "github.com/fulcrumchain/indigo/rpc"
)

type LightIndigo struct {
	config *eth.Config
...
func New(ctx context.Context, sctx *node.ServiceContext, config *eth.Config) (*LightIndigo, error) {
...
func (s *LightIndigo) APIs() []rpc.API {
...
func (s *LightIndigo) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *LightIndigo) BlockChain() *light.LightChain      { return s.blockchain }
func (s *LightIndigo) TxPool() *light.TxPool              { return s.txPool }
func (s *LightIndigo) Engine() consensus.Engine           { return s.engine }
func (s *LightIndigo) LesVersion() int                    { return int(s.protocolManager.SubProtocols[0].Version) }
func (s *LightIndigo) Downloader() *downloader.Downloader { return s.protocolManager.downloader }
func (s *LightIndigo) EventMux() *event.TypeMux           { return s.eventMux }

// Protocols implements node.Service, returning all the currently configured
// network protocols to start.
func (s *LightIndigo) Protocols() []p2p.Protocol {
	return s.protocolManager.SubProtocols
}

// Start implements node.Service, starting all internal goroutines needed by the
// Indigo protocol implementation.
func (s *LightIndigo) Start(srvr *p2p.Server) error {
