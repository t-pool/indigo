...
import (
	...
	"github.com/fulcrumchain/indigo/common/mclock"
...
// Service implements an Indigo netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server       // Peer-to-peer server to retrieve networking infos
	eth    *eth.Indigo      // Full Indigo service if monitoring a full node
	les    *les.LightIndigo // Light Indigo service if monitoring a light node
...
func New(cfg Config, ethServ *eth.Indigo, lesServ *les.LightIndigo) *Service {
