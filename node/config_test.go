...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "indigo.ipc", false, filepath.Join(os.TempDir(), "indigo.ipc")},
		{"data", "indigo.ipc", false, "data/indigo.ipc"},
		{"data", "./indigo.ipc", false, "./indigo.ipc"},
		{"data", "/indigo.ipc", false, "/indigo.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "indigo.ipc", true, `\\.\pipe\indigo.ipc`},
		{"data", "indigo.ipc", true, `\\.\pipe\indigo.ipc`},
		{"data", `\\.\pipe\indigo.ipc`, true, `\\.\pipe\indigo.ipc`},
	}
