...
func TestVirtualHostHandler_validHost(t *testing.T) {
	for _, test := range []struct {
	...
	}{
		{
			name:   "any",
			vhosts: []string{"*"},
			valid:  []string{"google.com", "example.com", "indigo.io"},
		},
		{
			name:    "literal",
			vhosts:  []string{"test.indigo.io"},
			valid:   []string{"test.indigo.io"},
			invalid: []string{"a.indigo.io", "a.test.indigo.io"},
		},
		{
			name:    "subdomain",
			vhosts:  []string{"*.indigo.io"},
			valid:   []string{"test.indigo.io", "a.indigo.io", "a.b.indigo.io"},
			invalid: []string{"indigo.io"},
		},
		{
			name:    "multi",
